...
> **Important:** Authentication is required before executing any wallet, trading, staking, lending, DCA, confidential, or batch commands. The session persists across restarts.
