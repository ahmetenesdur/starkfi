...
> **MCP equivalent:** [Lending Tools](/docs/mcp/tools-lending) — `list_lending_pools`, `supply_assets`, `borrow_assets`, `repay_debt`, `close_position`, `monitor_lending_position`, `auto_rebalance_lending`
