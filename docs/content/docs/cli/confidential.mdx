...
> **MCP equivalent:** [Confidential Tools](/docs/mcp/tools-confidential) — `confidential_setup`, `confidential_fund`, `confidential_transfer`, `confidential_withdraw`, `confidential_ragequit`, `confidential_rollover`
