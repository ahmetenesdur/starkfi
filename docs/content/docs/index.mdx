...
**StarkFi** is a Starknet DeFi toolkit that lets you swap, stake, lend, DCA, batch, and manage your portfolio — all from the **terminal** or through **AI agents** via the MCP server.
...
34+ commands for every DeFi operation. Supports `--simulate` for dry-runs and `--json` for machine-readable output.

→ [CLI Reference](/docs/cli)

### MCP Server — For AI Agents

34 typed tools that integrate with Claude, Cursor, Antigravity, and any MCP-compatible client. AI agents can swap tokens, manage DCA orders, monitor lending positions, rebalance portfolios, and execute batch operations.

→ [MCP Server](/docs/mcp)

### Agent Skills — For Automated Workflows

11 pre-packaged multi-step workflows that AI agents can trigger with natural language prompts like _"Stake my STRK with the best validator"_ or _"DCA 100 USDC into ETH daily"_.
