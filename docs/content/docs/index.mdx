...
35+ commands for every DeFi operation. Supports `--simulate` for dry-runs and `--json` for machine-readable output.

→ [CLI Reference](/docs/cli)

### MCP Server — For AI Agents

35 typed tools that integrate with Claude, Cursor, Antigravity, and any MCP-compatible client. AI agents can swap tokens, manage DCA orders, monitor lending positions, rebalance portfolios, and execute batch operations.
