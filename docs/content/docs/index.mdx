...
**StarkFi** is a Starknet DeFi toolkit that lets you swap, stake, lend, DCA, batch, transfer confidentially, and manage your portfolio — all from the **terminal** or through **AI agents** via the MCP server.
...
41 commands across 12 groups for every DeFi operation. Supports `--simulate` for dry-runs and `--json` for machine-readable output.

→ [CLI Reference](/docs/cli)

### MCP Server — For AI Agents

42 typed tools that integrate with Claude, Cursor, Antigravity, and any MCP-compatible client. AI agents can swap tokens, manage DCA orders, monitor lending positions, transfer confidentially, rebalance portfolios, and execute batch operations.
