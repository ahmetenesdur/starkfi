---
title: Agent Skills
description: 11 pre-packaged multi-step workflows for AI agents — install in one command
---
...
Install all 11 StarkFi skills into your AI assistant with a single command:
