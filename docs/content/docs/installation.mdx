...
| ---------------- | ----------------------------------------------------------------- |
| **CLI**          | 50 commands across 14 groups — trading, staking, lending, DCA, troves, LST, confidential, batch, portfolio, and more |
| **MCP Server**   | 51 typed tools — start with `npx starkfi@latest mcp-start`       |
