...
| ---------------- | ----------------------------------------------------------------- |
| **CLI**          | 34+ commands for trading, staking, lending, DCA, and wallet management |
| **MCP Server**   | 34 typed tools — start with `npx starkfi@latest mcp-start`       |
| **Agent Skills** | 11 pre-packaged workflows in the `skills/` folder                 |
