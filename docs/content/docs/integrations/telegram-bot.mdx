...
See the repo's [Setup Guide](https://github.com/ahmetenesdur/starkfi-telegram-bot/blob/main/docs/SETUP.md) for full configuration and [Deployment Guide](https://github.com/ahmetenesdur/starkfi-telegram-bot/blob/main/docs/DEPLOYMENT.md) for production (Docker, PM2, systemd).
