...
It should list all 42 tools across Auth, Wallet, Trade, Staking, Lending, DCA, and Confidential categories.
...
- **[MCP Overview](/docs/mcp)** — Tool categories, discovery, and architecture
- **[Auth & Config Tools](/docs/mcp/tools-auth)** — First tools to verify after setup
- **[Security Architecture](/docs/architecture/security)** — MCP security model and tool sandboxing
