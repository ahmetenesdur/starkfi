---
title: MCP Server
description: 34 MCP tools for AI-native Starknet DeFi automation
---
...
| **Lending**       | 9     | `list_lending_pools`, `get_lending_position`, `supply_assets`, `withdraw_assets`, `borrow_assets`, `repay_debt`, `close_position`, `monitor_lending_position`, `auto_rebalance_lending` |
...
3. AI clients connect and discover all 34 tools with JSON schemas
