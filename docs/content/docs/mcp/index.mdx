...
- **[MCP Setup](/docs/mcp/setup)** — Configure Claude Desktop, Cursor, and Antigravity
- **[Agent Skills](/docs/skills)** — Pre-packaged multi-step workflows (complementary to MCP tools)
- **[Security Architecture](/docs/architecture/security)** — MCP security model, tool hints, and sandboxing
