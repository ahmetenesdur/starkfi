...
> **⚠️ Warning:** Do **not** use this tool for Endur LST positions (xSTRK). LST yield is embedded in the share price — there are no separate rewards to claim. Use `lst_redeem` or `lst_exit_all` instead. See [LST Tools](/docs/mcp/tools-lst).
...
> **⚠️ Warning:** Do **not** use this tool for Endur LST positions. LST yield is automatic via share price appreciation. See [LST Tools](/docs/mcp/tools-lst).

---

> **CLI equivalent:** [Staking Commands](/docs/cli/staking)
