...
| Tool Identifier | Functional Description                                                                                                                                                                                                    |
| --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `config_action` | Views and modifies global CLI behavior: RPC routing (set/get), network selection, and Gas Abstraction (Gasless mode: user pays in STRK, ETH, USDC, USDT, or DAI via Paymaster; Gasfree mode: developer sponsors all gas). |
